...
2. Determine if they collectively form a complete reasoning chain for the original question.
3. Identify any missing facts or logical gaps.
...
def get_answer_prompt(reasoning_chain_text: str, question: str) -> list:
    """生成最终答案生成 prompt。"""
    return [
